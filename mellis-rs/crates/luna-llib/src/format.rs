...
pub const LLIB_FORMAT_VERSION: u16 = 1;
pub const LLIB_COMPILER_VERSION: u16 = 1; // v1.0
pub const LLIB_MVIR_VERSION: u16 = 1;
...
impl SectionType {
    pub fn from_u32(val: u32) -> Option<Self> {
        match val {
            ...
            16 => Some(SectionType::SemanticMetadata),
...
pub type MlibHeader = LlibHeader;
...
impl LlibHeader {
    pub fn new() -> Self {
        ...
        Self {
            magic: LLIB_MAGIC,
            format_version: LLIB_FORMAT_VERSION,
            compiler_version: LLIB_COMPILER_VERSION,
            mvir_version: LLIB_MVIR_VERSION,
            target_triple,
            module_uuid: [0u8; 16],
            module_hash: 0,
            timestamp: 0,
