...
fn test_mutual_exclusivity_copy_drop() {
    let src = r#"
        ...
        impl core::Drop for MyStruct {
            fn drop(self: &rw Self) {}
        }

        impl core::Copy for MyStruct {}
...
fn test_valid_copy() {
    let src = r#"
        ...
        impl core::Copy for ValidStruct {}
...
fn test_generic_instantiation_copy_drop() {
    let src = r#"
        ...
        impl<T> core::Copy for Wrapper<T> {}
