...
fn test_m1_external_rejects_local() {
    ...
    let loc_path = dir.join("local_only.ms");
...
fn test_m1_local_accepts_local() {
    ...
    let loc_path = dir.join("mylocal.ms");
...
fn test_m4_cross_provider_private_rejected() {
    ...
    let p_sec = dir.join("prov_secret.ms");
    fs::write(&p_sec, r#"
        module secmod {
